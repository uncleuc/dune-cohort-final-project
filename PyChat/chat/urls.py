...
urlpatterns = [
    ...
    path('conversations/<int:conversation_id>/history/', views.message_history, name='message_history'),
    path('conversations/<int:conversation_id>/action/', views.conversation_action, name='conversation_action'),
    path('conversations/<int:conversation_id>/send/', views.send_message, name='send_message'),
    path('conversations/<int:conversation_id>/upload/', views.upload_attachment, name='upload_attachment'),
